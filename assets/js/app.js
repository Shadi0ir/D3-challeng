...
//Set up the radius for each dot in the graph
//===========================================
var circRadius;
function crGet() {
  if (width <= 550) {
...
// Set xText a transform property that places it at the bottom of the chart.
...
// append Poverty,Age and Income SVG files
// 1. Poverty
xText
  .append("text")
  .attr("y", -26)
...
// B) Left Axis
// ============
// Specifying the margin for variables
